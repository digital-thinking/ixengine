...
public class WorldObserver {
     ...
     */
    private final IntMap<BodyChange> bodyChanges = new IntMap<BodyChange>();
    /**
     ...
     */
    private final IntMap<FixtureChange> fixtureChanges = new IntMap<FixtureChange>();
    /**
     * the JointChanges used to track Joints
     */
    private final ObjectMap<Joint, JointChange> jointChanges = new ObjectMap<Joint, JointChange>();
    /**
     ...
     */
    private final IntMap<Body> currentBodies = new IntMap<Body>(), previousBodies = new IntMap<Body>();
    /**
     ...
     */
    private final IntMap<Fixture> currentFixtures = new IntMap<Fixture>(), previousFixtures = new IntMap<Fixture>();
    /**
     * the Joints since this/the last time {@link #update(World, float)} was called
     */
    private final Array<Joint> currentJoints = new Array<Joint>(), previousJoints = new Array<Joint>();
    /**
    ...
    public static class UnexpectedListener implements Listener {
         ...
         */
        private final ObjectMap<Body, ExpectationBase> bases = new ObjectMap<Body, ExpectationBase>();
        /**
