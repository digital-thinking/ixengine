...
public class TweenedAnimation extends Animation {
    ...
    protected void update(BoneRef ref, Bone root, int time) {
        ...
        if (bone2 != null && tweenTarget != null && bone1 != null) {
            if (isObject)
                this.tweenObject((BoneObject) bone1, (BoneObject) bone2, (BoneObject) tweenTarget, this.weight, this.curve);
    ...
    private void tweenObject(BoneObject boneObject1, BoneObject boneObject2, BoneObject target, float t, Curve curve) {
        this.tweenBone(boneObject1, boneObject2, target, t, curve);
