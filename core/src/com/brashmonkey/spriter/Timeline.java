...
public class Timeline {
    ...
    public static class Key {
        ...
        public void setBoneObject(BoneObject boneObject) {
            if (boneObject == null) throw new IllegalArgumentException("object can not be null!");
            this.boneObject = boneObject;
        }

        public BoneObject object() {
            return this.boneObject;
        }
        ...
        public static class Bone {
            ...
            public boolean isBone() {
                return !(this instanceof BoneObject);
            }
         ...
         * @author Trixt0r
         */
        public static class BoneObject extends Bone {

            public final FileReference ref;
            public float alpha;

            public BoneObject(Point position, Point scale, Point pivot, float angle, float alpha, FileReference ref) {
                super(position, scale, pivot, angle);
                this.alpha = alpha;
                this.ref = ref;
            }

            public BoneObject(Point position) {
                this(position, new Point(1f, 1f), new Point(0f, 1f), 0f, 1f, new FileReference(-1, -1));
            }

            public BoneObject(BoneObject boneObject) {
                this(boneObject.position.copy(), boneObject.scale.copy(), boneObject.pivot.copy(), boneObject.angle, boneObject.alpha, boneObject.ref);
            }
             ...
             *
             * @param boneObject the object
             */
            public void set(BoneObject boneObject) {
                this.set(boneObject.position, boneObject.angle, boneObject.scale, boneObject.pivot, boneObject.alpha, boneObject.ref);
            }
